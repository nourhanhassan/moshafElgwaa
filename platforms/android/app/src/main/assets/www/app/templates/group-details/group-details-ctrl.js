app.controller("GroupDetailsController", ["$scope", "$state", "$stateParams", "$ionicPopup", "groupAdd", "target", "enums", "ionicLoading", "user", "$ionicScrollDelegate", "$timeout", "settings", "ayatData", "$ionicNavBarDelegate", "$rootScope", function ($scope, $state, $stateParams, $ionicPopup, groupAdd, target, enums, ionicLoading, user, $ionicScrollDelegate, $timeout, settings, ayatData, $ionicNavBarDelegate, $rootScope) {

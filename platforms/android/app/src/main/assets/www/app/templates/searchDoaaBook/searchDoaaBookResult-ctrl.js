...
app.controller("searchDoaaBookResultController", ["$scope", "moshafdata", "$state", "$rootScope", "$sce", "$ionicHistory", "mark", "enums", "settings", function ($scope, moshafdata, $state, $rootScope, $sce, $ionicHistory, mark, enums, settings) {
